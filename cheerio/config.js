...
module.exports = {
    ...
    cInitUrl : '/ershoufang/zhangjiang/d12', //以特定板块为入口，查询版块内的房源单价升序查询，只查前60个单价最低的。

    //性能参数
    cDcInterval : 2380, //两次采集之间的时间
    cMaxPageNum : 10, //采集页面的数量，如果太多可能会造成内存溢出。
    ...
    //excel导出时的列名
    cEsfFieldsName2:['笋度','小区名','核定单价','小区单价','房源单价','综合折率','总价','折率','楼层','折率','面积','折率','标题','地址'],
    cEsfFields2:{
        _id:0,
